...
                            </div>
                             <div class="form-group mb-3">
                                <input type="text" placeholder="Name" id="name" class="form-control" name="prenom" autofocus>
...
                            </div>
                            <div class="form-group mb-3">
                                <input type="date" placeholder="Password" id="password" class="form-control" name="datedenaissance">
